...
datos_totales_Tidy_Pregunta6 <- datos_totales_Tidy %>%
  ...
  group_by(Respuestas) %>% 
  summarise(Cantidad_de_rtas = n()) %>%
  mutate(Sintoma = "6-SensacionDeFracaso")
...
respuesta_5_en_todas_prom <- 

 
  respuesta_5_en_todas %>% ggplot(aes(x = Preguntas, y = Cantidad)) +
  geom_col(width = 0.5, color = "blue", fill = "red") +
  labs(x = "Respuestas",
       y = "Cantidad de Respuestas",
       title = "Respuesta ganadora en cada pregunta") + 
  theme_minimal()
...
pensamiento_suicida_entre15y20
...
#grafico respuesta ganadora en este rango de edades entre 20 y 25
```{r}
...
respuestas_por_pregunta_entre20y25 %>% ggplot(aes(x = Respuestas, y = Cantidad_de_rtas)) +
  geom_col(width = 0.5, color = "blue") +
  labs(x = "Respuestas",
       y = "Cantidad de Respuestas",
       title = "Respuesta ganadora en cada pregunta") + 
...
-----------------------------------------------------------------------------------------
#FLASHEADA - Filtrado de Datos en Hombres de 21 anios. Y uso de sus respuestas limite 1 y 5 como valores aleatorios  
